...
function parseShapeNode(filename, i) {
  ...
  let effect = effect_unparsed
    ...
    .map( e => e
      ...
      // Эффекты и бонусы
      .replace(/(Строительство|Пуски|Орбита|Астроинженерия|Терраформинг|Генные модификации|Дипломатия|Шпионаж|Контршпионаж|Пропаганда|Автозаки|Политика|Конверсия|Регенерация|Ремонт) \+(\d+)/, '$1:$2')
